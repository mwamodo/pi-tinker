...
class QnAComponent implements Component {
    ...
    /** Shown when Enter on the last question cannot open the submit dialog yet */
    private submitBlockedHint: string | null = null;
    ...
    private submit(): void {
        if (!this.allQuestionsAnswered()) {
            ...
            this.submitBlockedHint = "Answer every question before submitting.";
            this.invalidate();
            this.tui.requestRender();
            return;
        }
    ...
    render(width: number): string[] {
        ...
        if (this.showingConfirmation) {
            ...
            if (this.submitBlockedHint) {
                lines.push(
                    padToWidth(boxLine(truncateToWidth(this.yellow(this.submitBlockedHint), contentWidth))),
                );
            }
