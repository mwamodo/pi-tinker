...
import { DynamicBorder, getAgentDir, loadProjectContextFiles } from "@earendil-works/pi-coding-agent";
...
function getLoadedProjectContextFiles(cwd: string): Array<{ path: string; tokens: number; bytes: number }> {
...
export default function contextExtension(pi: ExtensionAPI) {
    ...
    pi.registerCommand("context", {
        ...
        handler: async (_args, ctx: ExtensionCommandContext) => {
            ...
            const agentFiles = getLoadedProjectContextFiles(ctx.cwd);
