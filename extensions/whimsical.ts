...
const messages = [
    ...
    // long and funny
    "Staring at the diff until it confesses...",
    "Asking the types to please just agree...",
    "Gaslighting the linter...",
    "Pretending the tests are optional...",
    "Blaming it on the framework...",
    "Googling the error message with attitude...",
    "Ctrl+Z-ing life choices...",
    "Writing 'temporary fix' in permanent ink...",
    "Leaving a TODO for future self...",
    "Apologizing to future self in advance...",
    "Touching it anyway...",
    "Naming a variable 'thing2'...",
    "Remembering 'thing1' doesn't exist...",
    "Incrementing the retry count with regret...",
    "Catching the exception and doing nothing about it...",
    "Shipping it and watching carefully...",
    "Shipping it and immediately going offline...",
    "Persuading the race condition it was never there...",
    "Introducing a bug to fix another bug...",
    "Fixing the fix that fixed the first fix...",
    "Declaring type bankruptcy...",
    "Casting to `any` and feeling fine about it...",
    "Reverting to the version that 'just worked'...",
    "Silently judging past self's variable names...",
    "Asking if it's an env issue (it's an env issue)...",
    "Turning it off and on again with great ceremony...",
    "Clearing the cache as an act of faith...",
    "Running `npm install` into the void...",
    "Deleting `node_modules` as therapy...",
    "Waiting for `npm install` to remember what joy feels like...",
    "Upgrading dependencies and immediately regretting it...",
    "Downgrading dependencies with a heavy heart...",
    "Checking if it works in production 'just this once'...",
    "Reading the docs for the first time, out of options...",
    "Skimming the docs and pretending that counts...",
    "Approving the PR and praying...",
    "Scheduling the post-mortem before the incident...",
    "Writing the incident report in iambic pentameter...",
    "Blaming DNS one last time for old times' sake...",
    "Realizing it was DNS all along...",
    "Achieving a breakthrough on the toilet...",
    "Losing the breakthrough by the time of return...",
    "Explaining the bug by explaining it to no one...",
    "Watching the bug disappear under observation...",
    "Waiting for the Heisenbug to show itself...",
    "Declaring it a feature and updating the docs...",
    "Searching git blame with quiet fury...",
    "Finding out it was you in the git blame...",
];
