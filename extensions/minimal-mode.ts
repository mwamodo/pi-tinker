...
export default function (pi: ExtensionAPI) {
    ...
    registerTool(pi, {
        ...
        label: "edit",
        description:
            "Edit a file by replacing exact text. Supports one or more replacements via edits[]. Each oldText must match exactly (including whitespace). Use this for precise, surgical edits.",
